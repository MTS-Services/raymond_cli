...
│   │
│   ├── components/                         # Feature-based section components
...
│   │   │   ├── AnimatedButton.jsx        # GSAP-animated button
│   │   │   ├── Breadcrumb.jsx            # Navigation breadcrumb
│   │   │   ├── Modal.jsx                 # Generic modal
│   │   │   ├── Pagination.jsx            # Pagination control
│   │   │   ├── TablePagination.jsx       # Table pagination
│   │   │   ├── PropertiesCTA.jsx         # Reusable CTA banner
...
│   │   │   └── ServicesSection.jsx
│   │   │
│   │   ├── terms/                         # Terms & Conditions sections
│   │   │   ├── HeroSection.jsx
│   │   │   └── PolicyContentSection.jsx
│   │   │
│   │   ├── privacy/                       # Privacy Policy sections
│   │   │   ├── HeroSection.jsx
│   │   │   └── PolicyContentSection.jsx
│   │   │
│   │   ├── wholesale/                     # Wholesale page sections
│   │   │   ├── HeroBanner.jsx
│   │   │   ├── ListingsSection.jsx
│   │   │   └── WholesaleCard.jsx
│   │   │
│   │   ├── buy/                           # Buy page sections
│   │   │   └── ListingsSection.jsx        # Includes FilterPanel internally
│   │   │
│   │   ├── properties/                    # Properties page sections
│   │   │   └── ListingsSection.jsx        # Includes FilterSidebar internally
│   │   │
│   │   ├── property/                      # Property detail sections
│   │   │   ├── PhotoGallerySection.jsx
│   │   │   └── PropertyInfoSection.jsx    # isOffer prop toggles offer mode
│   │   │
│   │   ├── mortgage/                      # Mortgage page sections
│   │   │   ├── HeroSection.jsx
│   │   │   ├── MortgageCalcSection.jsx
│   │   │   ├── RefinanceCalcSection.jsx
│   │   │   ├── LoanTypesSection.jsx
│   │   │   └── ApplicationFormSection.jsx
│   │   │
│   │   ├── new-construction/              # New Construction page sections
│   │   │   ├── HeroSection.jsx
│   │   │   ├── ProjectsSection.jsx
│   │   │   └── WhyInvestSection.jsx
│   │   │
│   │   ├── portfolio/                     # Portfolio & Case Study sections
│   │   │   ├── HeroBanner.jsx
│   │   │   ├── CaseStudiesSection.jsx
│   │   │   ├── CaseStudyHeroSection.jsx
│   │   │   ├── CaseStudyProjectSection.jsx
│   │   │   ├── CaseStudyGallerySection.jsx
│   │   │   └── CaseStudyFeaturesSection.jsx
│   │   │
│   │   ├── renovation/                    # Renovation family sections
│   │   │   ├── RenovationHeroSection.jsx
│   │   │   ├── RenovationServicesSection.jsx
│   │   │   ├── RenovationProcessSection.jsx
│   │   │   ├── RenovationGallerySection.jsx
│   │   │   ├── RenovationQuoteSection.jsx
│   │   │   ├── RenovationPhotoGallery.jsx
│   │   │   ├── RenovationDetailsSection.jsx
│   │   │   ├── RenovationServiceHero.jsx
│   │   │   ├── RenovationServiceList.jsx
│   │   │   ├── BeforeAfterSection.jsx
│   │   │   ├── RenovationServiceProcess.jsx
│   │   │   └── RenovationServiceQuote.jsx
│   │   │
│   │   ├── investment/                    # Investment page sections
│   │   │   ├── InvestmentHeroSection.jsx  # Hero + Why Invest
│   │   │   ├── InvestmentOpportunitiesSection.jsx
│   │   │   ├── InvestmentProcessSection.jsx
│   │   │   └── InvestmentContactSection.jsx
│   │   │
│   │   ├── consultation/                  # Book Consultation sections
│   │   │   └── BookConsultationSection.jsx
│   │   │
│   │   ├── chat/                          # Chat page sections
│   │   │   └── ChatPanel.jsx              # Pure chat UI (no Navbar/Footer)
│   │   │
...
│   │   ├── Properties.jsx
│   │   ├── PropertyDetails.jsx
│   │   ├── PropertyDetailsOffer.jsx
│   │   ├── ReduxDemo.jsx
│   │   ├── Register.jsx
│   │   ├── Renovation.jsx
│   │   ├── RenovationDetails.jsx
│   │   ├── RenovationService.jsx
│   │   ├── ResetPassword.jsx
│   │   ├── Services.jsx
│   │   ├── TermsCondition.jsx
│   │   ├── Wholesale.jsx
...
### Architectural Pattern: Section-Based Components

Every public page follows a consistent three-layer architecture:

#### Layer 1 — Page File (`src/pages/Foo.jsx`)

Owns SEO, scroll restoration, and page layout. **Never** contains business logic or visual content.
...
const Foo = memo(() => {
  ...
  return (
    <div className='min-h-screen bg-white'>
      <ScrollRestoration />   {/* react-router-dom — always at page root */}
      <Navbar />
      <main>
        <FooHeroSection />
        <FooContentSection />
        <PropertiesCTA />    {/* optional shared CTA */}
      </main>
      <Footer />
    </div>
  );
...
#### Layer 2 — Section Files (`src/components/[feature]/FooSection.jsx`)

Each section is a `memo()`-wrapped component with:

- Its own `ASSETS` / static data constants (co-located, not in a separate data file)
- `displayName` set on every `memo()` component
- No knowledge of Navbar, Footer, or scroll position
- Self-contained sub-components (card, row, step, etc.) defined in the same file

```jsx
const ASSETS = { heroBg: '/images/hero.webp' };
const ITEMS = [{ id: 'a', title: '...' }];

const ItemCard = memo(({ item }) => <div>{item.title}</div>);
ItemCard.displayName = 'ItemCard';

const FooHeroSection = memo(() => <section>...</section>);
FooHeroSection.displayName = 'FooHeroSection';

export default FooHeroSection;
```

#### Layer 3 — Shared Components (`src/components/shared/`)

Reusable building blocks used across multiple features: `Navbar`, `Footer`, `AnimatedButton`, `PropertyCard`, `PropertiesCTA`, `Pagination`, etc.

### Structural Design Principles

1. **Feature-Based Organization**: Section files grouped by feature under `components/[feature]/`
2. **Co-located Static Data**: `ASSETS` and data arrays live in the same file as the section that uses them
3. **Single Responsibility**: Each section file renders exactly one visual section
4. **Page-Owned Shell**: Navbar, Footer, ScrollRestoration, and useSEO belong exclusively to page files
5. **Memo by Default**: All components wrapped in `React.memo()` with explicit `displayName`
6. **Scalability**: Adding a new section = add one file, add one import to the page
