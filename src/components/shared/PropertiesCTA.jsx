...
const PropertiesCTA = memo(() => (
  <section className=''>
 <div className='mx-auto max-w-384 px-4 sm:px-8 lg:px-12'>
      <div className='relative flex min-h-75 flex-col justify-center overflow-hidden rounded-2xl bg-navy p-8 sm:p-10 lg:p-16'>
        ...
        {/* Content Container */}
        <div className='relative z-10 max-w-full space-y-5 sm:max-w-md lg:max-w-137.5 lg:space-y-6'>
...
PropertiesCTA.displayName = 'PropertiesCTA';
