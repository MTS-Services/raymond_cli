...
const ResultCard = memo(({ value, label }) => {
  ...
  const numPart = hasDollar ? value.slice(1) : value;
  return (
...
const CaseStudyFeaturesSection = memo(() => (
  <>
      ...
      <div className="max-w-384 mx-auto px-4 sm:px-8 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-10 xl:gap-16 items-center">
          ...
          >
            ...
            <div
              className="absolute rounded-2xl overflow-hidden border-[3px] border-white shadow-xl"
              style={{
                left: "57.8%",
                top: "31.9%",
                width: "42.2%",
